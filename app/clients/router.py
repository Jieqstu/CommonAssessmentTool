...
Handles all HTTP requests for client operations including create, read, update, and 
delete.
"""
...
async def get_client_services(
    ...
    """Get all services and their status for a specif
    ic client, including case worker info"""
